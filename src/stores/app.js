...
export const useAppStore = defineStore('app', {
  state: () => ({
    ...
    carouselItems: [
      {
        ...
        image: '/src/assets/new_images/1.jpg',
        imageHeight: 150,
      ...
      },
      {
        ...
        image: '/src/assets/new_images/2.jpg',
        imageHeight: 275,
      ...
      },
      {
        ...
        image: '/src/assets/new_images/3.jpg',
        imageHeight: 275,
    ...
    // Team descriptions for different institutes
    teamDescriptions: {
      ...
      'Other Collaborators': 'Other collaborating researchers are from various institutions including University of Münster, UNEP, IIASA, and other leading organizations contributing to our mission of understanding and mitigating urban emissions.'
    },
    
    // Method popup data for different sectors
    methodPopups: {
      'power': {
        ...
        imagePath: '/src/assets/method/method_power.png',
        references: [
      ...
      'traffic': {
        ...
        cards: [
          ...
          },
          {
            color: '#5C64B7',
            title: 'Gap Filling ',
            description: 'Multi-modal Transportation Network Model',
            icon: 'mdi-road'
          },
          {
            color: '#2196F3',
            title: 'Dataset',
            description: 'City-level traffic patterns and vehicle emission factors',
            icon: 'mdi-map-marker'
          },
          {
            color: '#9C27B0',
            title: 'Emission Modeling',
            description: 'Vehicle-specific emission calculation model',
            icon: 'mdi-engine'
          },
          {
            color: '#00BCD4',
            title: 'Application',
            description: 'Real-time traffic emission monitoring and prediction',
            icon: 'mdi-chart-timeline-variant'
          }
        ],
        imagePath: '/src/assets/method/method_traffic.png',
        references: [
      ...
      'residential': {
        ...
        cards: [
          {
            color: '#4CAF50',
            title: 'Data Source',
            description: 'Building Energy Consumption, Population Density, Housing Types',
            icon: 'mdi-home'
          },
          {
            color: '#FF9800',
            title: 'Building Model',
            description: 'Building Energy Consumption Model',
            icon: 'mdi-office-building'
          },
          {
            color: '#2196F3',
            title: 'Dataset',
            description: 'Residential energy consumption and building characteristics',
            icon: 'mdi-home-city'
          },
          {
            color: '#9C27B0',
            title: 'Consumption Modeling',
            description: 'Socioeconomic-climate based residential model',
            icon: 'mdi-account-group'
          },
          {
            color: '#00BCD4',
        ...
        imagePath: '/src/assets/method/method_residential.png',
        references: [
          'Building Energy Research Group. (2024). "Residential energy consumption patterns in India."',
          'Census of India. (2024). "Housing characteristics and energy use statistics."',
          'Ministry of Housing. (2024). "Building energy efficiency standards and data."',
          'Urban Development Ministry. (2024). "City residential infrastructure mapping."'
        ],
        refLinks: [
          'https://www.ber-group.com/',
          'https://censusindia.gov.in/',
          'https://mohua.gov.in/',
          'https://urbanindia.gov.in/'
        ]
      },
      'industry': {
        ...
        cards: [
          {
            color: '#4CAF50',
            title: 'Data Source',
            description: 'Industrial Production Data, Energy Consumption, Facility Locations',
            icon: 'mdi-factory'
          },
          {
            color: '#FF9800',
            title: 'Industrial Model',
            description: 'Sector-specific Production-Emission Model',
            icon: 'mdi-cog'
          },
          {
            color: '#2196F3',
          ...
          },
          {
            ...
            description: 'Economic activity-based industrial emission model',
            icon: 'mdi-chart-industrial'
          },
          {
            color: '#00BCD4',
            title: 'Application',
        ...
        imagePath: '/src/assets/method/method_industry.png',
        references: [
          'Central Statistics Office. (2024). "Industrial production and energy consumption data."',
          'Ministry of Commerce. (2024). "Industrial sector statistics and analysis."',
          'Energy Efficiency Bureau. (2024). "Industrial energy consumption patterns."',
          'Environmental Protection Agency. (2024). "Industrial emission standards and monitoring."'
        ],
        refLinks: [
          'https://mospi.gov.in/',
      ...
      'aviation': {
        ...
        cards: [
          {
            color: '#4CAF50',
            title: 'Data Source',
            description: 'Flight Data, Aircraft Types, Airport Operations, Fuel Consumption',
            icon: 'mdi-airplane'
          },
          {
            color: '#FF9800',
            title: 'Aviation Model',
            description: 'Flight-based Emission Calculation Model',
            icon: 'mdi-flight'
          },
          {
            color: '#2196F3',
          ...
          },
          {
            ...
            description: 'Route-specific aviation emission model',
            icon: 'mdi-routes'
          },
          {
            color: '#00BCD4',
        ...
        imagePath: '/src/assets/method/method_aviation.png',
        references: [
          'Directorate General of Civil Aviation. (2024). "Flight data and aviation statistics."',
          'Airports Authority of India. (2024). "Airport operations and fuel consumption data."',
          'International Civil Aviation Organization. (2024). "Aviation emission calculation methodology."',
          'Ministry of Civil Aviation. (2024). "Indian aviation sector statistics."'
        ],
        refLinks: [
          'https://dgca.gov.in/',
          'https://aai.aero/',
        ...
        cards: [
          {
            color: '#4CAF50',
            title: 'Data Source',
            description: 'Brick Kiln Locations, Production Capacity, Fuel Types, Operating Seasons',
            icon: 'mdi-brick'
          },
          {
            color: '#FF9800',
            title: 'Kiln Model',
            description: 'Brick Kiln Emission Calculation Model',
            icon: 'mdi-fire'
          },
          {
            color: '#2196F3',
            title: 'Dataset',
            description: 'Brick kiln inventory and operational data',
            icon: 'mdi-map-marker-multiple'
          },
          {
            color: '#9C27B0',
            title: 'Production Modeling',
            description: 'Seasonal brick production and emission model',
            icon: 'mdi-calendar'
          },
          {
            color: '#00BCD4',
            ...
            icon: 'mdi-chart-seasonal'
          }
        ],
        imagePath: '/src/assets/method/method_brick.png',
        references: [
          'Central Pollution Control Board. (2024). "Brick kiln emission standards and monitoring."',
          'Ministry of Environment. (2024). "Brick manufacturing sector statistics."',
          'State Pollution Control Boards. (2024). "Regional brick kiln inventory and data."',
          'Brick Manufacturers Association. (2024). "Industry production and fuel consumption data."'
        ],
        refLinks: [
          'https://cpcb.nic.in/',
          'https://moef.gov.in/',
          'https://cpcb.nic.in/',
          'https://brick-manufacturers.org/'
        ]
      }
    }
  }),
